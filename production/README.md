...
| `pcf_mhd_divfree` | pcf | mhd | `examples/pcf_mri_primitive_jax.py` | production runner wired; bounded start/smoke-tier smoke tested and labeled `bounded_saturation_smoke`; full saturation execution pending at the Phase J5 `N=(32,64,32)` production tier | rung 3 |
