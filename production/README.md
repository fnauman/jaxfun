...
goldens, and three generated jaxfun saturation goldens so parity checks do not
...
| `pcf_mhd_divfree` | pcf | mhd | `examples/pcf_mri_primitive_jax.py` | production runner wired; bounded start/smoke-tier smoke tested and labeled `bounded_saturation_smoke`; full Phase J5 `N=(32,64,32)` execution reaches the generated-saturation gate, with promotion pending a passing saturation check | rung 3 |
