...
| `tc_supercritical_saturation` | taylor_couette | hydro | `examples/taylor_couette_dns_jax.py` | production runner wired; bounded smoke tested; full saturation execution pending | rung 2/3 |
