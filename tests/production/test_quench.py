...
def _parent():
    return {
        ...
        "nondimensional_groups": {"Re": 1000.0, "Rm": 1000.0, "nu": 1e-3, "eta_mag": 1e-3},
...
def test_checkpoint_bank_entry_records_provenance():
    entry = checkpoint_bank_entry(
        parent_run_id="run-A", child_run_id=None, t=32.0, tstep=6400,
        spec_hash="abc", representation="primitive", numerics_contract_version=2,
